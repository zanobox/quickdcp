/**
 * @file	qdcp_checksum.c
 * @author	slightly adapted from terence meiczinger's opendcp_checksum.c by zanobox.net
 * @brief	implements md5 and sha1 checksums 
 */
#include <stdlib.h>
#include <string.h>
#include <stddef.h>
...
void sha1_update(t_sha1 * context, const unsigned char* data, uint32_t len) {
    uint32_t i, j;
...
void sha1_final(unsigned char digest[20], t_sha1 * context) {
    unsigned i;
