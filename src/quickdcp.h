...
#define QDCP_NAME			"QuickDCP"
#define QDCP_VERSION_MAJ 	0
#define QDCP_VERSION_MIN 	1
#define QDCP_VERSION_REV 	1
#define QDCP_VERSION 		"0.1.1"
#define QDCP_VERSION_DATE 	"2016-09-24"
#define QDCP_COPYRIGHT  	"(c) 2014-2016 jean.sabatier@zanobox.net."
#define QDCP_LICENSE    	"The program is provided AS IS with NO WARRANTY OF ANY KIND, INCLUDING THE WARRANTY OF DESIGN, MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE."
#define QDCP_URL 			"https://github.com/zanobox/quickdcp"
...
#define PROGRAM				"quickdcp"
#define CFG_FILE 			"quickdcp.ini"
#define DCP_DIR 			"DCP"
...
#define TMPL_DIR			".templates"
	...
	#define SEPARATOR 		"\\"
	#define CFG_DIR 		"programs\quickdcp"
	...
	#define SEPARATOR 		"/"
	#define CFG_DIR 		".config/quickdcp"
	#define TMP_DIR 		".tmp"
	#define TMP_IMG 		".tmp/img"
	#define TMP_VID			".tmp/vid"
	#define TMP_SEQ 		".tmp/seq"
	...
	#define TMP_MXF 		".tmp/mxf"
	#define LOG_DIR 		".tmp/log"
	#define SHARE_DIR 		"/usr/local/share/quickdcp"
	// #define ICON_DIR 		"/usr/local/share/quickdcp/icons"
	#define ICON_DIR 		"/usr/local/share/icons/quickdcp"
	#define APP_ICON 		"/usr/local/share/icons/quickdcp/quickdcp.svg"
	// #define APP_ICON 		"/usr/local/share/quickdcp/icons/quickdcp.svg"
#endif
#ifdef APPLE
