...
if( NOT OPENJPEG2_FOUND )
    ...
    if( OPENJPEG2_INCLUDE_DIR )
      ...
      if(HAVE_STRUCT_OPJ_CIO)
        ...
        MESSAGE(WARNING "   OPENJPEG2_INCLUDE_DIR is not OpenJPEG-2.1")
      else(HAVE_STRUCT_OPJ_CIO)
        set(OPENJPEG2_INCLUDE_V2 TRUE)
        MESSAGE(STATUS "   OPENJPEG2_INCLUDE_DIR is OpenJPEG-2.1")
...
#      message(STATUS "Checking OpenJPEG header for v2 API - " ${OPENJPEG2_INCLUDE_V2})
    ...
    find_library( OPENJPEG2_LIBRARIES libopenjp2.a
		PATH_SUFFIXES
			openjpeg-2.1			
    )
    message(STATUS "Looking for libopenjpeg2 - ${OPENJPEG2_LIBRARIES}")
    ...
    if( OPENJPEG2_LIBRARIES )
      ...
      if(HAVE_OPJ_CIO_OPEN)
        ...
        MESSAGE(WARNING "   OPENJPEG2_LIBRARIES is not OpenJPEG-2.1")
      else(HAVE_OPJ_CIO_OPEN)
        set(OPENJPEG2_LIBRARIES_V2 TRUE)
        MESSAGE(STATUS "   OPENJPEG2_LIBRARIES is OpenJPEG-2.1")
